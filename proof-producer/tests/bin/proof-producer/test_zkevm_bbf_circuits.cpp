...
// const std::string SimpleIncrement = "exp_simple";
...
// ./build/bin/nild run --http-port 8529 -l debug --collator-tick-ms 20000
// solc -o . --bin --abi example/counter.sol --overwrite
// # increase `defaultNewWalletAmount` value in nil/cmd/nil/internal/wallet/new.go to be able to create whale account
