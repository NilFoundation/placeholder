    ...
    namespace proof_generator {
        ...
        class circuit_writer {
                public:
                    ...
                    using Circuit = nil::blueprint::circuit<ArithmetizationType>;

                public:
                    explicit circuit_writer(std::ostream& out) : out_(out) {}
                    circuit_writer(const circuit_writer&) = delete;
                    circuit_writer& operator=(const circuit_writer&) = delete;
                    circuit_writer(circuit_writer&&) = delete;
                    ...
                    */
                    ...
                    void write_binary_circuit(const Circuit& circuit,
                                              const std::vector<std::size_t>& public_input_column_sizes) {

                        namespace marshalling_types = nil::crypto3::marshalling::types;
                        using value_marshalling_type = marshalling_types::plonk_constraint_system<TTypeBase, ArithmetizationType>;
                        ...
                        auto filled_val =
                            value_marshalling_type(std::make_tuple(
                                marshalling_types::fill_plonk_gates<Endianness, typename ArithmetizationType::gates_container_type::value_type>(circuit.gates()),
                                marshalling_types::fill_plonk_copy_constraints<Endianness, typename ArithmetizationType::field_type>(circuit.copy_constraints()),
                                marshalling_types::fill_plonk_lookup_gates<Endianness, typename ArithmetizationType::lookup_gates_container_type::value_type>(circuit.lookup_gates()),
                                marshalling_types::fill_plonk_lookup_tables<Endianness, typename ArithmetizationType::lookup_tables_type::value_type>(circuit.lookup_tables()),
                                public_input_sizes
                        ));
                        ...
                        out_.write(reinterpret_cast<char*>(cv.data()), cv.size());
                    }
