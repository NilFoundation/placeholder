#ifndef PROOF_GENERATOR_ASSIGNER_PREPROCESS_COMMAND_HPP
#define PROOF_GENERATOR_ASSIGNER_PREPROCESS_COMMAND_HPP
    ...
    namespace proof_generator {
                    ...
                    auto public_preprocessed_data = std::make_shared<PublicPreprocessedData>(
                        nil::crypto3::zk::snark::placeholder_public_preprocessor<BlueprintField, PlaceholderParams>::
                            process(
                                ...
                                *table_description_,
                                *lpc_scheme,
                                this->config_.max_quotient_chunks
                            )
                    );
        ...
        struct PreprocessCommand: public command_chain {
            ...
            PreprocessCommand(const Args& args) {
                ...
                auto& circuit_reader = add_step<CircuitReader>(args.circuit_file_path);             // read circuit file
                auto& table_reader = add_step<TableReader>(args.assignment_table_file_path);        // read table file
...
#endif // PROOF_GENERATOR_ASSIGNER_PREPROCESS_COMMAND_HPP
