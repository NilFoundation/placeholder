#ifndef PROOF_GENERATOR_ASSIGNER_COMPUTE_COMBINED_Q_COMMAND_HPP
#define PROOF_GENERATOR_ASSIGNER_COMPUTE_COMBINED_Q_COMMAND_HPP
    ...
    namespace proof_generator {
        ...
        struct CombinedQGeneratorCommand: public command_chain {            
            ...
            struct Args {
                ...
                std::size_t             combined_Q_starting_power;
                boost::filesystem::path combined_Q_polynomial_file;
            };
            ...
            CombinedQGeneratorCommand(const Args& args) {        
                ...
                auto& lpc_scheme_provider = add_step<LpcSchemeReader>(args.lpc_scheme_file);
                add_step<CombinedQGenerator>(lpc_scheme_provider, args.aggregated_challenge_file, args.combined_Q_starting_power, args.combined_Q_polynomial_file);
            }
        };
...
#endif // PROOF_GENERATOR_ASSIGNER_COMPUTE_COMBINED_Q_COMMAND_HPP
