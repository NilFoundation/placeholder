#ifndef PROOF_GENERATOR_ASSIGNER_COMPUTE_AGG_FRI_PROOF_COMMAND_HPP
#define PROOF_GENERATOR_ASSIGNER_COMPUTE_AGG_FRI_PROOF_COMMAND_HPP
...
namespace nil {
    namespace proof_generator {
            ...
            struct AggregatedFriProofGenerator: 
                public CommitmentSchemeFactory<CurveType, HashType>,
                public command_step
             {
            ...
            private:
                ...
                {                    
                    ...
                    auto lpc_scheme = this->make_lpc_scheme(table_description_->rows_amount);
        ...
        struct AggregatedFriProofCommand: public command_chain {            
            ...
            struct Args {
                PlaceholderConfig config;
                boost::filesystem::path table_description_file;
                boost::filesystem::path aggregated_challenge_file;
                std::vector<boost::filesystem::path> input_combined_Q_polynomial_files;
                boost::filesystem::path aggregated_fri_proof_output_file;
                boost::filesystem::path proof_of_work_output_file;
            ...
            AggregatedFriProofCommand(const Args& args) {        
                ...
                auto& table_description_provider = add_step<TableDescriptionReader>(args.table_description_file);
                add_step<AggregatedFriProofGenerator>(
                    args.config, 
                    table_description_provider, 
                    args.aggregated_challenge_file, 
                    args.input_combined_Q_polynomial_files, 
                    args.aggregated_fri_proof_output_file, 
                    args.proof_of_work_output_file, 
...
#endif // PROOF_GENERATOR_ASSIGNER_COMPUTE_AGG_FRI_PROOF_COMMAND_HPP
