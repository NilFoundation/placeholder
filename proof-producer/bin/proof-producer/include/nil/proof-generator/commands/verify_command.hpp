#ifndef PROOF_GENERATOR_ASSIGNER_VERIFY_COMMAND_HPP
#define PROOF_GENERATOR_ASSIGNER_VERIFY_COMMAND_HPP
    ...
    namespace proof_generator {
        ...
        public:
            struct Args {
                ...
                boost::filesystem::path common_data_file_path;
            ...
            VerifyCommand(const Args& args) {
                ...
                auto& table_description_reader = add_step<AssignmentDescriptionReader>(args.assignment_description_file_path);
                auto& common_data_reader       = add_step<CommonDataReader>(args.common_data_file_path);
                auto& proof_reader             = add_step<ProofReader>(args.proof_file_path);
                add_step<Verifier>(
                    args.config,
                    circuit_reader,
