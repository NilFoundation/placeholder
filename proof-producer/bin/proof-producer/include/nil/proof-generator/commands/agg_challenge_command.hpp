#ifndef PROOF_GENERATOR_ASSIGNER_AGG_CHALLENGE_COMMAND_HPP
#define PROOF_GENERATOR_ASSIGNER_AGG_CHALLENGE_COMMAND_HPP
...
namespace nil {
    namespace proof_generator {
        ...
        struct AggregatedChallengeCommand: public command_step {
            ...
            struct Args {
                std::vector<boost::filesystem::path> aggregate_input_files;
            ...
            CommandResult execute() override {
                return generate_aggregated_challenge_to_file(
                    args_.aggregate_input_files, 
                    args_.aggregated_challenge_file
                );
            }
...
#endif // PROOF_GENERATOR_ASSIGNER_AGG_CHALLENGE_COMMAND_HPP