#ifndef PROOF_GENERATOR_ASSIGNER_MERGE_PROOFS_COMMAND_HPP
#define PROOF_GENERATOR_ASSIGNER_MERGE_PROOFS_COMMAND_HPP
    ...
    namespace proof_generator {
        ...
        struct MergeProofsCommand: public command_step {
            ...
            struct Args {
                ...
                boost::filesystem::path aggregated_FRI_proof_file;
                boost::filesystem::path merged_proof_file;
            };
            ...
            CommandResult execute() override {
                return merge_proofs(
                    args_.partial_proof_files,
                    args_.initial_proof_files,
                    args_.aggregated_FRI_proof_file,
                    args_.merged_proof_file
                );
            }
...
#endif // PROOF_GENERATOR_ASSIGNER_MERGE_PROOFS_COMMAND_HPP