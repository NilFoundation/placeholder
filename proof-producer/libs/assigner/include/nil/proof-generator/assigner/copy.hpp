...
#include <nil/proof-generator/assigner/test_l1_wrapper.hpp>
...
namespace nil {
    namespace proof_generator {
        ...
        std::optional<std::string> fill_copy_events_assignment_table(nil::crypto3::zk::snark::plonk_assignment_table<BlueprintFieldType>& assignment_table,
            ...
            BOOST_LOG_TRIVIAL(debug) << "table usable rows before " << assignment_table.rows_amount() << "\n";
            ...
            // BOOST_LOG_TRIVIAL(debug) << "table usable rows after " << assignment_table.rows_amount() << "\n";
            ...
            bool result = test_l1_wrapper_with_proof_verification<BlueprintFieldType, nil::blueprint::bbf::copy>(
                {7}, input, copy_constraint_input,
