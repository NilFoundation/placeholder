...
namespace nil {
    namespace proof_generator {
        ...
        std::optional<std::string> initialize_add_circuit(
                ...
                std::optional<nil::crypto3::zk::snark::plonk_table<BlueprintFieldType, nil::crypto3::zk::snark::plonk_column<BlueprintFieldType>>>& add_table) {
            ...
            add_circuit.emplace();
            add_table.emplace(desc.witness_columns, desc.public_input_columns, desc.constant_columns, desc.selector_columns);
