...
contract modular_lookup_argument_circuit3_lpc is ILookupArgument{
//library modular_lookup_argument_circuit3_lpc{
    ...
    function verify(
        ...
        state.V_L_value = basic_marshalling.get_uint256_be(zvalues, 0x80 + 0x180);
        state.V_L_shifted_value = basic_marshalling.get_uint256_be(zvalues, 0x80 + 0x180 + 0x20);
        ...
        tr_state.current_challenge = tr_state_before;
        {
			...
			uint256 prod;
// -- lookup 0 is inlined -- 
		state.selector_value=basic_marshalling.get_uint256_be(blob, 192);
		l = mulmod( 1,state.selector_value, modulus);
		state.theta_acc=state.theta;
		sum = 0;
		prod = basic_marshalling.get_uint256_be(blob, 288);
...
// -- /lookup 0 is inlined -- 
			state.selector_value = basic_marshalling.get_uint256_be(blob, 224);
			state.shifted_selector_value = basic_marshalling.get_uint256_be(blob, 256);
			l = mulmod( 1, state.selector_value, modulus);
