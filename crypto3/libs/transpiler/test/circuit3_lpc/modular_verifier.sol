...
contract modular_verifier_circuit3_lpc is IModularVerifier{
    uint256 constant modulus = 28948022309329048855892746252171976963363056481941560715954676764349967630337;
    bytes32 constant vk1 = bytes32(0x6adc783bc6410f5f6096ed8afc945e147912ed7968ee8c8328d39b719290ff36);
    bytes32 constant vk2 = bytes32(0x0135147bd721778cdd0f06b087116365113a014455f587505926b5d5b003ff92);
    ...
    uint64  constant table_end_offset = 0x2c9;
    uint64  constant quotient_offset = 0x1c0;
    ...
    uint64  constant quotient_size = 6;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit3_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[0x149:0x2c9], public_input, state)) {
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit3_lpc.verify_eval(
