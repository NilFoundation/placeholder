...
library modular_commitment_scheme_circuit3_lpc {
    ...
    uint256 constant _eta = 28332996414751078199837534523343515621967797943285038261131048669438535256547;
    uint64  constant fixed_batch_size = 7;
    bytes constant point_ids = hex"000100010001000100010000010000000001000000000000000102000102"; // 1 byte -- point id
    bytes constant poly_points_num = hex"001300090002"; // 2 byte lengths
    bytes constant poly_ids = hex"00000040008000c001000140018001c002000240028002c003000340038003c004000440048000000040008000c00100018002800440048004400480"; // 2 byte poly_id 2 byte
    ...
    function prepare_eval_points(uint256[unique_points] memory result, uint256 xi) internal view {
		...
		result[2] = mulmod(xi, field.pow_small(omega, 4, modulus), modulus);
    ...
    function prepare_eta_U(uint256 theta) internal pure returns (uint256 result){
		result = addmod(0x19195a03406f5adbe0eefb85cf9c181a72bf5df61168210543d02209c3b35d4a, mulmod(result, theta, modulus), modulus);
		result = addmod(0x3535f2a78d3aca3ad97ad3b4038caa941daa00934f5892e03b9f65897928a921, mulmod(result, theta, modulus), modulus);
		result = addmod(0x3ab400f06cd5c6ac722190aedd6d14baf055e502869b319aa0c2ab70efd7f040, mulmod(result, theta, modulus), modulus);
		result = addmod(0x78e0272f8700c9a1e6ca4b023f933bb555574b623437e93fd738dda609e59d9, mulmod(result, theta, modulus), modulus);
		result = addmod(0x118b579047ff4e41c28256d5aba2e45f1d69e93fee24a271465c942f63150371, mulmod(result, theta, modulus), modulus);
		result = addmod(0x30a926ea262f3f4b29e50ce03e03a79646f6930c8872619cf70fdd57f52bd08, mulmod(result, theta, modulus), modulus);
		result = addmod(0x2ea620e68ff2e6f492f7dff828f702d84fb46a3de9521837e379dc7143d13c90, mulmod(result, theta, modulus), modulus);
