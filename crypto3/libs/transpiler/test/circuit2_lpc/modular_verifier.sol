...
contract modular_verifier_circuit2_lpc is IModularVerifier{
    uint256 constant modulus = 52435875175126190479447740508185965837690552500527637822603658699938581184513;
    bytes32 constant vk1 = bytes32(0xdb89bc23edc617bd990ccd1201cda09f5168259e485c710e212409a9b80d9c68);
    bytes32 constant vk2 = bytes32(0x5ceae91ff0023e7faa77a70a168d37c9e124ca36ddd8e2913389d87c44074467);
    ...
    uint64  constant table_offset = 0x1e1;
    uint64  constant special_selectors_offset = 353;
    uint64  constant table_end_offset = 0x2a1;
    uint64  constant quotient_offset = 0x100;
    ...
    uint64  constant quotient_size = 5;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit2_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[0x1e1:0x2a1], public_input, state)) {
            ...
            
        {
            ...
            (permutation_argument, tr_state.current_challenge) = modular_permutation_argument_circuit2_lpc.verify(
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit2_lpc.verify_eval(
