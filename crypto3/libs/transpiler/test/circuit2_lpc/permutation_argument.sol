...
library modular_permutation_argument_circuit2_lpc{
    uint256 constant modulus = 52435875175126190479447740508185965837690552500527637822603658699938581184513;
    uint256 constant permutation_size = 3;
    uint256 constant special_selectors_offset = 3 * 0x40;
    uint256 constant table_values_offset = 3 * 0x40 + 0x80;
    bytes constant zero_indices = hex"00a000600080";
    uint32 constant max_quotient_chunks = 0;
    ...
    function verify(
        ...
        F[1] = mulmod(
            ...
            addmod(
                mulmod(basic_marshalling.get_uint256_be(blob, table_values_offset + 192 + 0x20), state.h, modulus),
