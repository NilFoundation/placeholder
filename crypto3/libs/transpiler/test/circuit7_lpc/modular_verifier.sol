...
contract modular_verifier_circuit7_lpc is IModularVerifier{
    uint256 constant modulus = 28948022309329048855892746252171976963363056481941560715954676764349967630337;
    bytes32 constant vk1 = bytes32(0xb1f3ba6743c7fb21dad05c0423895d8d89c20610e3b710d50a9bc2d58dde427d);
    bytes32 constant vk2 = bytes32(0xe959230d3a2d20829fdcd11822fa9c0f41491b76a29219f9ed7c29d5058dc241);
    ...
    uint64  constant table_offset = 0x149;
    uint64  constant special_selectors_offset = 201;
    uint64  constant table_end_offset = 0x549;
    uint64  constant quotient_offset = 0x440;
    ...
    uint64  constant quotient_size = 26;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit7_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[0x149:0x549], public_input, state)) {
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit7_lpc.verify_eval(
