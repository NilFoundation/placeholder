...
contract modular_verifier_circuit1_lpc is IModularVerifier{
    uint256 constant modulus = 28948022309329048855892746252171976963363056481941560715954676764349967630337;
    bytes32 constant vk1 = bytes32(0xa8fbe72354699772b3befc839c072c73deb82be28478e70fa920a0d4548a2419);
    bytes32 constant vk2 = bytes32(0xea2b4c5e046500bbbfcc98de48f82a439fd2dcfbd1925f1b4cd364c99b67ed12);
    ...
    uint64  constant z_offset = 0x79;
    uint64  constant table_offset = 0xf9;
    uint64  constant special_selectors_offset = 121;
    uint64  constant table_end_offset = 0x1b9;
    uint64  constant quotient_offset = 0xc0;
    ...
    uint64  constant quotient_size = 3;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit1_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        state.b = true;
        state.xi = basic_marshalling.get_uint256_be(blob, 0x51);
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[0xf9:0x1b9], public_input, state)) {
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit1_lpc.verify_eval(
