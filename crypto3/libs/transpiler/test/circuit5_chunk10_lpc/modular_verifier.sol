...
contract modular_verifier_circuit5_chunk10_lpc is IModularVerifier{
    ...
    uint64  constant quotient_offset = 0xc20;
    ...
    uint64  constant quotient_size = 10;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit5_chunk10_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
            ...
            
        {
            ...
            (permutation_argument, tr_state.current_challenge) = modular_permutation_argument_circuit5_chunk10_lpc.verify(
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit5_chunk10_lpc.verify_eval(
