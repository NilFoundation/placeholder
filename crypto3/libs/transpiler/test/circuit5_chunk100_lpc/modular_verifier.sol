...
contract modular_verifier_circuit5_chunk100_lpc is IModularVerifier{
    uint256 constant modulus = 28948022309329048855892746252171976963363056481941560715954676764349967630337;
    bytes32 constant vk1 = bytes32(0x7f0c48c20a455d9cfc1ac81dd0c722e34bc0ca0b00d15d8f486cb8af63cfbd1d);
    bytes32 constant vk2 = bytes32(0x18960f9e5ad0002b40128e5bb1325b655f9a4c8dba5c3533d0d50f0fb41bfb58);
    ...
    uint64  constant table_offset = 0x8e1;
    uint64  constant special_selectors_offset = 2145;
    uint64  constant table_end_offset = 0x1461;
    uint64  constant quotient_offset = 0xbc0;
    ...
    uint64  constant quotient_size = 32;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit5_chunk100_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[0x8e1:0x1461], public_input, state)) {
            ...
            
        {
            ...
            (permutation_argument, tr_state.current_challenge) = modular_permutation_argument_circuit5_chunk100_lpc.verify(
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit5_chunk100_lpc.verify_eval(
