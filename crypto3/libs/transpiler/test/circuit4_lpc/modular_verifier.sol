...
contract modular_verifier_circuit4_lpc is IModularVerifier{
    uint256 constant modulus = 28948022309329048855892746252171976963363056481941560715954676764349967630337;
    bytes32 constant vk1 = bytes32(0xb445aeaefab28c55be9b90c3db35a6acdb391d5016b6e1b9018132d1dd1f906f);
    bytes32 constant vk2 = bytes32(0x5383f3ffde695c6e3c3f727a5a69cf4008fd0c0b59ab62ee3a29683e2bd182dc);
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit4_lpc.initialize(tr_state.current_challenge);
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit4_lpc.verify_eval(
