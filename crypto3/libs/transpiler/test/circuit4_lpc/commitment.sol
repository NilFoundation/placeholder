...
library modular_commitment_scheme_circuit4_lpc {
    ...
    uint256 constant _eta = 15098178156069201057331325407145426463945184473102968663938732992947077737067;
    uint64  constant fixed_batch_size = 8;
    bytes constant point_ids = hex"00010001000100010001000000010000000001000000000000000102000102"; // 1 byte -- point id
    bytes constant poly_points_num = hex"001400090002"; // 2 byte lengths
    bytes constant poly_ids = hex"00000040008000c001000140018001c002000240028002c003000340038003c004000440048004c000000040008000c0010001c002c0048004c0048004c0"; // 2 byte poly_id 2 byte
    ...
    function prepare_eval_points(uint256[unique_points] memory result, uint256 xi) internal view {
		...
		result[2] = mulmod(xi, field.pow_small(inversed_omega, 3, modulus), modulus);
    ...
    function prepare_eta_U(uint256 theta) internal pure returns (uint256 result){
		result = addmod(0x2c8ba8c47952f55cc34304aae0e449e6ce8f0a1207c3fc8a69f31855dca1e862, mulmod(result, theta, modulus), modulus);
		result = addmod(0x3b7168fddad94e2f524c52794aedc416ae214f78976842b8791615cae092e24e, mulmod(result, theta, modulus), modulus);
		result = addmod(0x3e6e8cf1abdde675f21f38277fca4758e6be0754a7242b12166b1f8c50dff61f, mulmod(result, theta, modulus), modulus);
		result = addmod(0x18c190d46ba9c19c6e2b3bf53b6ad5d4055e8f31db868a8f63bb20fb90149236, mulmod(result, theta, modulus), modulus);
		result = addmod(0x15c46ce09aa52955ce585647068e5291ccc1d755cbcaa235c666173a1fc77e65, mulmod(result, theta, modulus), modulus);
		result = addmod(0x132dba3e4621781d4e85628291e3e3c3d07bbab774d9e8689250640bb44dcc1f, mulmod(result, theta, modulus), modulus);
		result = addmod(0x37c19a3265a90ac15e906cf4a59d817831e1971d7204694eb44ce31638745591, mulmod(result, theta, modulus), modulus);
		result = addmod(0xcccfccfbf7da70f4f2340920f74ba71648a4b62092d463004f768f8e6f8c824, mulmod(result, theta, modulus), modulus);
