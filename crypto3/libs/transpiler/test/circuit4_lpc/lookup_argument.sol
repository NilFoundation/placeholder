...
contract modular_lookup_argument_circuit4_lpc is ILookupArgument{
//library modular_lookup_argument_circuit4_lpc{
    ...
    function verify(
        ...
        state.V_L_value = basic_marshalling.get_uint256_be(zvalues, 0x80 + 0x1a0);
        state.V_L_shifted_value = basic_marshalling.get_uint256_be(zvalues, 0x80 + 0x1a0 + 0x20);
...
// -- lookup 0 is inlined -- 
		...
		state.theta_acc = mulmod(state.theta_acc, state.theta, modulus);
		sum = 0;
		prod = basic_marshalling.get_uint256_be(blob, 384);
		sum = addmod(sum, prod, modulus);
...
// -- /lookup 0 is inlined -- 
			state.selector_value = basic_marshalling.get_uint256_be(blob, 256);
			state.shifted_selector_value = basic_marshalling.get_uint256_be(blob, 288);
			l = mulmod( 1, state.selector_value, modulus);
