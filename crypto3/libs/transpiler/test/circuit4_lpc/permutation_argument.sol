...
library modular_permutation_argument_circuit4_lpc{
    ...
    function verify(
        ...
        state.V_P_value = basic_marshalling.get_uint256_be(blob, table_values_offset + 416);
        state.h = 1;
        state.g = 1;
        ...
        for(uint256 i = 0; i < permutation_size;){
            ...
            if( cur == max_quotient_chunks - 1 ){
                state.current_value = basic_marshalling.get_uint256_be(blob, table_values_offset + 416 + 0x40 + (chunk<<5));
                F[1] = addmod(
                    F[1],
                    mulmod(
        ...
        state.previous_value = state.current_value;
        state.current_value = basic_marshalling.get_uint256_be(blob, table_values_offset + 416 + 0x20);
        F[1] = addmod(
            F[1],
            addmod(
                mulmod(state.previous_value,state.g, modulus),
