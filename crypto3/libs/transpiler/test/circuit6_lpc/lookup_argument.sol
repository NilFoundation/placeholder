...
contract modular_lookup_argument_circuit6_lpc is ILookupArgument{
//library modular_lookup_argument_circuit6_lpc{
...
// -- /lookup 1 is inlined -- 
			...
			state.shifted_selector_value = basic_marshalling.get_uint256_be(blob, 224);
			l = mulmod( 1, state.selector_value, modulus);
