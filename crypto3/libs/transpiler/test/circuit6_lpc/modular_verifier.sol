...
contract modular_verifier_circuit6_lpc is IModularVerifier{
    uint256 constant modulus = 28948022309329048855892746252171976963363056481941560715954676764349967630337;
    bytes32 constant vk1 = bytes32(0xbfc518cc872ed39c5e08143a8b5c8ce3cb1d6cf2aa171d59f272df87b48b5a44);
    bytes32 constant vk2 = bytes32(0x5121f0380ea7a13da3b8c1fe7be572f30fe082037344396cf9ae9da910fd4ef0);
    ...
    uint64  constant table_end_offset = 0x2e9;
    uint64  constant quotient_offset = 0x1e0;
    ...
    uint64  constant quotient_size = 17;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_circuit6_lpc.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[0x149:0x2e9], public_input, state)) {
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_circuit6_lpc.verify_eval(
