...
//
//  Contains eval_multiply for big_integer, which does nothing but converts it to
...
namespace nil::crypto3::multiprecision {
    ...
    inline constexpr void eval_multiply(big_integer<Bits1 + Bits2> &result,
                                        const big_integer<Bits1> &a,
    ...
    // If the second argument is trivial or not, we still assign it to the first the exact
    // same way.
    template<unsigned Bits1, unsigned Bits2>
    inline constexpr void eval_multiply(big_integer<Bits1> &result, const big_integer<Bits2> &a,
    ...
    inline constexpr void eval_multiply(big_integer<Bits1> &result, const limb_type &b) noexcept {
    ...
    template<unsigned Bits1, unsigned Bits2>
    inline constexpr void eval_multiply(big_integer<Bits1> &result,
