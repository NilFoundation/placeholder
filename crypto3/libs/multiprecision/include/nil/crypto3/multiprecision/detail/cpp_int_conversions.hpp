...
namespace nil::crypto3::multiprecision {
    ...
    template<std::size_t Bits>
    constexpr unsigned_cpp_int_type<Bits> to_cpp_int(const big_uint<Bits>& a) {
    ...
    template<std::size_t Bits>
    constexpr big_uint<Bits> to_big_uint(unsigned_cpp_int_type<Bits> cppint) {
    ...
    template<std::size_t Bits>
    constexpr signed_cpp_int_type<Bits> to_cpp_int(const big_int<Bits>& a) {
    ...
    template<std::size_t Bits>
    constexpr big_int<Bits> to_big_int(const signed_cpp_int_type<Bits>& cppint) {
