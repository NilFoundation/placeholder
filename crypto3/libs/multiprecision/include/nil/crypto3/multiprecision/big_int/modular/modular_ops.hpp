...
namespace nil::crypto3::multiprecision::detail {
    ...
    struct modular_policy {
        ...
        constexpr static std::size_t limbs_count = big_uint_t::internal_limb_count;
        constexpr static std::size_t limb_bits = big_uint_t::limb_bits;

        constexpr static std::size_t BitsCount_doubled = 2u * Bits;
        constexpr static std::size_t BitsCount_doubled_1 = BitsCount_doubled + 1;
        constexpr static std::size_t BitsCount_quadruple_1 = 2u * BitsCount_doubled + 1;
        constexpr static std::size_t BitsCount_padded_limbs = limbs_count * limb_bits + limb_bits;
        constexpr static std::size_t BitsCount_doubled_limbs = 2u * limbs_count * limb_bits;
        constexpr static std::size_t BitsCount_doubled_padded_limbs =
    ...
    class barrett_modular_ops {
      public:
        ...
        constexpr static std::size_t limbs_count = policy_type::limbs_count;
        constexpr static std::size_t limb_bits = policy_type::limb_bits;
