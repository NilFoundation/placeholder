...
struct std::hash<
    nil::crypto3::multiprecision::big_mod_impl<modular_ops_storage_t>> {
    std::size_t operator()(const nil::crypto3::multiprecision::big_mod_impl<modular_ops_storage_t>& a) const noexcept {
        return boost::hash<nil::crypto3::multiprecision::big_mod_impl<modular_ops_storage_t>>{}(a);
    }
};