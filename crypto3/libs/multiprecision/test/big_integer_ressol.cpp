...
//
//     constexpr auto a4 =
//     0xc5067ee5d80302e0561545a8467c6d5c98bc4d37672eb301c38ce9a9_cppui_modular224; constexpr auto
//     p4 = 0xffffffffffffffffffffffffffffffff000000000000000000000001_cppui_modular224; constexpr
//     auto res4 = 0x115490c2141baa1c2407abe908fcf3416b0cb0d290dcd3960c3ec7a7_cppui_modular224;
...
//
//     using modular_adaptor_type_4 = backends::modular_adaptor<cpp4,
//     backends::modular_params_rt<cpp4>>; constexpr auto a1_m =
//         number<modular_adaptor_type_4>(modular_adaptor_type_4(0x5_cppui_modular4,
//         0xb_cppui_modular4));
//     constexpr auto res1 = 0x4_cppui_modular4;
//     static_assert(ressol(a1_m).template convert_to<number<cpp4>>() == res1, "ressol error");
//
//     using modular_adaptor_type_521 = backends::modular_adaptor<cpp521,
//     backends::modular_params_rt<cpp521>>; constexpr auto a2_m =
//     number<modular_adaptor_type_521>(modular_adaptor_type_521(
...
//
//     using modular_adaptor_type_224 = backends::modular_adaptor<cpp224,
//     backends::modular_params_rt<cpp224>>; constexpr auto a4_m =
//     number<modular_adaptor_type_224>(modular_adaptor_type_224(
...
//     constexpr auto res4 =
//     0x115490c2141baa1c2407abe908fcf3416b0cb0d290dcd3960c3ec7a7_cppui_modular224;
//     static_assert(ressol(a4_m).template convert_to<number<cpp224>>() == res4, "ressol error");
//
//     using modular_adaptor_type_7 = backends::modular_adaptor<cpp7,
//     backends::modular_params_rt<cpp7>>; constexpr auto a5_m =
//     number<modular_adaptor_type_7>(modular_adaptor_type_7(0x40_cppui_modular7,
//     0x55_cppui_modular7)); constexpr auto negone_5 =
//     number<modular_adaptor_type_7>(modular_adaptor_type_7(0, 0x55_cppui_modular7));
//     static_assert(ressol(a5_m) == negone_5, "ressol error");
//
//     using modular_adaptor_type_8 = backends::modular_adaptor<cpp8,
//     backends::modular_params_rt<cpp8>>; constexpr auto a6_m =
//     number<modular_adaptor_type_8>(0xb5_cppui_modular8, 0xd9_cppui_modular8); constexpr auto
//     negone_6 = number<modular_adaptor_type_8>(0, 0xd9_cppui_modular8); static_assert(ressol(a6_m)
//     == negone_6, "ressol error");
//
//     constexpr auto a7_m =
//         number<backends::modular_adaptor<cpp16,
//         backends::modular_params_rt<cpp16>>>(0x1081_cppui_modular16, 0x8181_cppui_modular16);
//     constexpr auto negone_7 =
//         number<backends::modular_adaptor<cpp16,
//         backends::modular_params_rt<cpp16>>>(number<cpp16>(-1), 0x8181_cppui_modular16);
//     static_assert(ressol(a7_m) == negone_7, "ressol error");
//
//     constexpr auto a8_m =
//         number<backends::modular_adaptor<cpp15,
//         backends::modular_params_rt<cpp15>>>(0x800_cppui_modular15, 0x7ab9_cppui_modular15);
//     constexpr auto negone_8 = number<backends::modular_adaptor<cpp15,
//     backends::modular_params_rt<cpp15>>>(
//         number<cpp15>(-1), 0x7ab9_cppui_modular15);
//     static_assert(ressol(a8_m) == negone_8, "ressol error");
//
//     constexpr auto a9_m =
//         number<backends::modular_adaptor<cpp13,
//         backends::modular_params_rt<cpp13>>>(0x2_cppui_modular13, 0x1111_cppui_modular13);
//     constexpr auto negone_9 = number<backends::modular_adaptor<cpp13,
//     backends::modular_params_rt<cpp13>>>(
//         number<cpp13>(-1), 0x1111_cppui_modular13);
//     static_assert(ressol(a9_m) == negone_9, "ressol error");
//
//     constexpr auto a10_m = number<backends::modular_adaptor<cpp315,
//     backends::modular_params_rt<cpp315>>>(
...
//         number<backends::modular_adaptor<cpp18,
//         backends::modular_params_rt<cpp18>>>(0x400_cppui_modular18, 0x2aaab_cppui_modular18);
//     constexpr auto res11 = 0x2aa8b_cppui_modular18;
//     static_assert(ressol(a11_m).template convert_to<number<cpp18>>() == res11, "ressol error");
//
//     constexpr auto a12_m = number<backends::modular_adaptor<cpp315,
//     backends::modular_params_rt<cpp315>>>(
...
//
//     constexpr auto a13_m = number<backends::modular_adaptor<cpp315,
//     backends::modular_params_rt<cpp315>>>(
...
//
//     constexpr auto a14_m = number<backends::modular_adaptor<cpp315,
//     backends::modular_params_rt<cpp315>>>(
