    ...
    namespace actor {
        ...
        public:
            ...
            fused_downstream_manager(stream_manager *parent) :
                super(parent), nested_(parent, detail::pack_repeat<Ts>(parent)...) {
        ...
        protected:
            ...
            bool check_paths_impl(path_algorithm algo, path_predicate &pred) const noexcept override {
                auto f = [&](const typename map_type::value_type &x) { return pred(*x.second.ptr); };
                switch (algo) {
                    default:    // all_of
