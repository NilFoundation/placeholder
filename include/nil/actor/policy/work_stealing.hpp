    ...
    namespace actor {
        namespace policy {
            ...
            public:
                ...
                // The coordinator has only a counter for round-robin enqueue to its middleman_workers.
                struct coordinator_data {
                    inline explicit coordinator_data(scheduler::abstract_coordinator *) : next_worker(0) {
                        // nop
                    }
                ...
                struct worker_data {
                    ...
                    // This queue is exposed to other middleman_workers that may attempt to steal jobs
