...
namespace nil {
    namespace actor {
        ...
        /// @experimental
        class BOOST_SYMBOL_VISIBLE actor_profiler {
        public:
...
#define ACTOR_BEFORE_PROCESSING(self, msg) self->system().profiler_before_processing(*self, msg)
#define ACTOR_AFTER_PROCESSING(self, result) self->system().profiler_after_processing(*self, result)
#define ACTOR_BEFORE_SENDING(self, msg) self->system().profiler_before_sending(*self, msg)
#define ACTOR_BEFORE_SENDING_SCHEDULED(self, timeout, msg) \
    self->system().profiler_before_sending_scheduled(*self, timeout, msg)
#else
#define ACTOR_BEFORE_PROCESSING(self, msg) static_cast<void>(0)
#define ACTOR_AFTER_PROCESSING(self, result) static_cast<void>(0)
#define ACTOR_BEFORE_SENDING(self, msg) static_cast<void>(0)
#define ACTOR_BEFORE_SENDING_SCHEDULED(self, timeout, msg) static_cast<void>(0)
#endif
