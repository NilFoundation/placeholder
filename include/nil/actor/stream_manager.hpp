    ...
    namespace actor {
        ...
        public:
            ...
            outbound_stream_slot<Out> add_unchecked_outbound_path(Handle next) {
                ...
                return add_unchecked_outbound_path_impl(std::move(hdl), std::move(handshake));
            }
            ...
            /// @private
            stream_slot add_unchecked_outbound_path_impl(response_promise &rp, message handshake);

            /// Adds a new outbound path to `next`.
            /// @private
            stream_slot add_unchecked_outbound_path_impl(strong_actor_ptr next, message handshake);
