        ...
        namespace intrusive {
            ...
            public:
                ...
                inbox_result push_front(pointer new_element) noexcept {
                    ACTOR_ASSERT(new_element != nullptr);
                    ...
                    while (e != eof) {
                        ...
                        if (stack_.compare_exchange_strong(e, new_element))
                            return e == reader_blocked_tag() ? inbox_result::unblocked_reader : inbox_result::success;
                ...
                pointer take_head(pointer new_head) noexcept {
                    ...
                    // empty.
                    ACTOR_ASSERT(new_head == stack_closed_tag() || new_head == stack_empty_tag());
                    pointer e = stack_.load();
                    // Must not be called on a closed queue.
                    ACTOR_ASSERT(e != stack_closed_tag());
                    ...
                    ACTOR_ASSERT(e != reader_blocked_tag() || new_head == stack_closed_tag());
                    ...
                    while (e != new_head) {
                        if (stack_.compare_exchange_weak(e, new_head)) {
                            ...
                            if (is_empty_or_blocked_tag(e)) {
                                ...
                                ACTOR_ASSERT(new_head == stack_closed_tag());
                                return nullptr;
                            }
                            return e;
                        }
                ...
                bool synchronized_emplace_front(Mutex &mtx, CondVar &cv, Ts &&... xs) {
                    return synchronized_push_front(mtx, cv, new value_type(std::forward<Ts>(xs)...));
                }
