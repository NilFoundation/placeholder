...
namespace nil {
    namespace actor {
        ...
        using sorted_builtin_types = detail::type_list<actor,                                 // @actor
        ...
        struct type_nr {
            static constexpr uint16_t value =
                static_cast<uint16_t>(detail::tl_index_of<sorted_builtin_types, T>::value + 1);
        };
        ...
        struct type_nr<T, true> {
            ...
            static constexpr uint16_t value =
                static_cast<uint16_t>(detail::tl_index_of<sorted_builtin_types, type>::value + 1);
        };

        template<>
        struct type_nr<bool, true> {
            static constexpr uint16_t value =
                static_cast<uint16_t>(detail::tl_index_of<sorted_builtin_types, bool>::value + 1);
        };
        ...
        static constexpr size_t type_nrs = detail::tl_size<sorted_builtin_types>::value + 1;
