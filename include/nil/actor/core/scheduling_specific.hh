...
namespace seastar {
    ...
    namespace internal {
        ...
        inline scheduling_group_specific_thread_local_data &get_scheduling_group_specific_thread_local_data() noexcept {
     ...
     * (function_traits<Reducer>::arg<0>) but then there is a danger when the Reducer accepts a parameter type T where
