...
namespace seastar {
    ...
    public:
        ...
        /// \param axis another \ref fair_queue_ticket to be used as a a base vector against which to normalize this
        /// fair_queue_ticket.
    ...
    public:
        ...
        [[deprecated(
            "fair_queue users should not track individual requests, but resources (weight, size) passing through the "
            "queue")]] size_t
            waiters() const;
