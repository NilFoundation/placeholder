...
namespace seastar {
    ...
    public:
        ...
        using timer_list_t =
            boost::intrusive::list<Timer,
                                   boost::intrusive::member_hook<Timer, boost::intrusive::list_member_hook<>, link>>;
    ...
    public:
        timer_set() noexcept : _last(0), _next(max_timestamp), _non_empty_buckets(0) {
        }
