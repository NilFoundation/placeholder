...
namespace seastar {
    ...
    SEASTAR_INCLUDE_API_V2 namespace api_v2 {
        ...
        [[deprecated("use Seastar_API_LEVEL=3 instead")]] output_stream<char> make_file_output_stream(
        ...
        /// newly created file.
        [[deprecated("use Seastar_API_LEVEL=3 instead")]] data_sink make_file_data_sink(file,
