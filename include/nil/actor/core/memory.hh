...
#error "Huge page size is not defined for this architecture"
        ...
        /// see [scylla-gdb.py]
        /// (https://github.com/scylladb/scylla/blob/e1b22b6a4c56b4f1d0adf65d1a11db4bcb51fe7d/scylla-gdb.py#L1439) This
        /// script can generate either textual representation of the data, or a zoomable flame graph ([flame graph
        /// generation instructions](https://github.com/scylladb/scylla/wiki/Seastar-heap-profiler), [example flame
