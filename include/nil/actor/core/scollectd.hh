...
namespace seastar {
    ...
    namespace scollectd {
        ...
        public:
            ...
            typedef typename std::conditional<is_callable<typename std::remove_reference<T>::type>::value, value_type,
                                              wrap<value_type>>::type stored_type;
        ...
        [[deprecated("Use the metrics layer")]] static type_instance_id
            add_polled_metric(const plugin_id &plugin, const plugin_instance_id &plugin_instance, const type_id &type,
        ...
        [[deprecated("Use the metrics layer")]] static type_instance_id
            ...
            seastar::metrics::impl::get_local_impl()->add_registration(
                to_metrics_id(id), arg.type, seastar::metrics::impl::make_function(arg.value, arg.type), d, enabled);
            return id;
        }
        /*!
         * \deprecated metrics registration should be done using the metrics layer
        ...
        typed_value::typed_value(const type_id &tid, const scollectd::type_instance &ti, description d,
            ...
            _type_id(tid),
            _type_instance(ti),
            _values(::seastar::make_shared<decltype(make_type_instance(std::move(d), std::forward<Args>(args)...))>(
