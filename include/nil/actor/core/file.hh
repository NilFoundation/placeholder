...
namespace seastar {
    ...
    private:
        ...
        future<temporary_buffer<uint8_t>> dma_read_exactly_impl(uint64_t pos, size_t len, const io_priority_class &pc,
                                                                io_intent *intent) noexcept;
    ...
    /// \param file_fut A future that produces a file
    /// \param func A function that uses a file
    /// \returns the future returned by \c func, or an exceptional future if \c file_fut failed or a nested exception if
