...
namespace nil {
    namespace actor {
        ...
        detail::enable_if_tt<detail::tl_contains<downstream_msg::alternatives, T>, downstream_msg>
        ...
        typename Inspector::result_type inspect(Inspector &f, downstream_msg::batch &x) {
        ...
        template<class Inspector>
        typename Inspector::result_type inspect(Inspector &f, downstream_msg::forced_close &x) {
