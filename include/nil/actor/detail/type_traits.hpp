        ...
        namespace detail {
            ...
            struct is_primitive {
                static constexpr bool value =
                    std::is_convertible<T, std::string>::value || std::is_convertible<T, std::u16string>::value ||
...
template <class T, class U,
          bool Enable = std::is_integral<T>::value
            ...
            template<class T, typename U>
            struct is_same_ish
                : std::conditional<std::is_same<T, U>::value, std::true_type, is_equal_int_type<T, U>>::type { };
            ...
            private:
                ...
                static auto sfinae(U *x)
                    -> std::integral_constant<bool, std::is_convertible<decltype(x->data()), To *>::value>;
