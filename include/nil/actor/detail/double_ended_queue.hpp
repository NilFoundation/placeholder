...
namespace nil::actor::detail {
    ...
    public:
        ...
        private:
            ...
            static constexpr size_type cline_size = ACTOR_CACHE_LINE_SIZE;
            static constexpr size_type pad_size = (cline_size * ((payload_size / cline_size) + 1)) - payload_size;
            // avoid false sharing
        ...
        static_assert(sizeof(node *) < ACTOR_CACHE_LINE_SIZE, "sizeof(node*) >= ACTOR_CACHE_LINE_SIZE");
    ...
    private:
        ...
        char pad1_[ACTOR_CACHE_LINE_SIZE - sizeof(node *)];
        // guarded by tail_lock_
        std::atomic<node *> tail_;
        char pad2_[ACTOR_CACHE_LINE_SIZE - sizeof(node *)];
