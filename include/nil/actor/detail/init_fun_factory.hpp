...
namespace nil {
    namespace actor {
        namespace detail {
            ...
            class BOOST_SYMBOL_VISIBLE init_fun_factory_helper_base
            ...
            public:
                ...
                init_fun_factory_helper(F fun, args_pointer args) : fun_(std::move(fun)), args_(std::move(args)) {
                    // nop
                }
                    ...
                    if constexpr (ReturnsBehavior) {
                        ...
                        if constexpr (args_empty) {
                            ...
                            if constexpr (HasSelfPtr) {
                                ...
                                auto res = apply_moved_args_prefixed(fun_, get_indices(*args_), *args_, dptr);
