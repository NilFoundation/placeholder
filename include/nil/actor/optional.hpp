...
namespace nil {
    namespace actor {
        ...
        public:
            ...
            optional(optional &&other) noexcept(std::is_nothrow_move_constructible<T>::value) : m_valid(false) {
                if (other.m_valid) {
            ...
            optional &operator=(optional &&other) noexcept(
                std::is_nothrow_destructible<T>::value &&std::is_nothrow_move_assignable<T>::value) {
                if (m_valid) {
                    if (other.m_valid)
        ...
        typename std::enable_if<Inspector::reads_state, typename Inspector::result_type>::type inspect(Inspector &f,
                                                                                                       optional<T> &x) {
        ...
        struct optional_inspect_helper {
            ...
            friend typename Inspector::result_type inspect(Inspector &f, optional_inspect_helper &x) {
