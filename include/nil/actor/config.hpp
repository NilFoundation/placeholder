...
#if defined(BOOST_COMP_GNUC_AVAILABLE) && !defined(_GLIBCXX_HAS_GTHREADS)
...
#if defined(BOOST_OS_WINDOWS_AVAILABLE) && defined(BOOST_COMP_CLANG_AVAILABLE)
