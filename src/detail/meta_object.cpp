...
#define fatal(str)                           \
    ...
    nil::actor::error_code<sec> save(const meta_object &meta, nil::actor::binary_serializer &sink, const void *obj) {
    ...
    nil::actor::error_code<sec> load(const meta_object &meta, nil::actor::binary_deserializer &source, void *obj) {
