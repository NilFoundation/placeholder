...
namespace nil { namespace actor {
    ...
    namespace memory {
        ...
        class page_list_link {
            ...
            friend nil::actor::internal::log_buf::inserter_iterator
                do_dump_memory_diagnostics(nil::actor::internal::log_buf::inserter_iterator);
        };
        ...
        static constexpr size_t max_small_allocation = small_pool::idx_to_size(small_pool_array::nr_small_pools - 1);
        ...
        bool cpu_pages::try_foreign_free(void *ptr) {
            ...
            if (__builtin_expect((reinterpret_cast<uintptr_t>(ptr) & cpu_id_and_mem_base_mask) == local_expected_cpu_id,
                                 true)) {
                return false;
            }
        ...
        memory::memory_layout cpu_pages::memory_layout() {
            ...
            return {reinterpret_cast<uintptr_t>(memory), reinterpret_cast<uintptr_t>(memory) + nr_pages * page_size};
        }
        ...
        void set_dump_memory_diagnostics_on_alloc_failure_kind(std::string_view str) {
            if (str == "none") {
                ...
                seastar_logger.error(
                    "Ignoring invalid option '{}' for the allocation failure kind to dump seastar memory diagnostics "
        ...
        nil::actor::internal::log_buf::inserter_iterator
            do_dump_memory_diagnostics(nil::actor::internal::log_buf::inserter_iterator it) {
        ...
        void maybe_dump_memory_diagnostics(size_t size) {
            ...
            logger::lambda_log_writer writer(
                [](nil::actor::internal::log_buf::inserter_iterator it) { return do_dump_memory_diagnostics(it); });
        ...
        sstring generate_memory_diagnostics_report() {
            nil::actor::internal::log_buf buf;
