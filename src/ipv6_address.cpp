...
namespace nil {
    namespace actor {
        ...
        bool ipv6_address::is_loopback() const noexcept {
            ...
            return embeds_v4() ? embedded_v4().is_loopback() :
        ...
        namespace {
            ...
            u16_range longest_streak(u16_iterator first, u16_iterator last) {
                ...
                auto range_size = [](u16_range x) { return std::distance(x.first, x.second); };
        ...
        std::string to_string(ipv6_address x) {
            ...
            auto add_chunk = [&](uint16_t chunk) { append_v6_hex(result, reinterpret_cast<uint8_t *>(&chunk)); };
