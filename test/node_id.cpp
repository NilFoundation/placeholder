...
#define CHECK_PARSE_FAIL(str) ACTOR_CHECK(!node_id::can_parse(str))

ACTOR_TEST(node IDs are not convertible from malformed strings) {
    // not URIs
