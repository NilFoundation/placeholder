...
BOOST_AUTO_TEST_CASE(typed_behavior_assignment) {
    ...
    // omit one handler
    BOOST_CHECK_EQUAL(bi_pair(false, -1), tb_assign<bh1>(f1));
    BOOST_CHECK_EQUAL(bi_pair(false, -1), tb_assign<bh1>(f2));
    BOOST_CHECK_EQUAL(bi_pair(false, -1), tb_assign<bh1>(g1));
    BOOST_CHECK_EQUAL(bi_pair(false, -1), tb_assign<bh1>(g2));
    BOOST_CHECK_EQUAL(bi_pair(false, -1), tb_assign<bh1>(e1));
    BOOST_CHECK_EQUAL(bi_pair(false, -1), tb_assign<bh1>(e2));
    // any valid alteration of (f1, f2, g1, g2)
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(f1, f2));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(f2, f1));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(g1, g2));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(g2, g1));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(g1, f2));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(f2, g1));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(f1, g2));
    BOOST_CHECK_EQUAL(bi_pair(true, 2), tb_assign<bh1>(g2, f1));
    // any invalid alteration of (f1, f2, g1, g2)
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(f1, g1));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(g1, f1));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(f2, g2));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(g2, g2));
    // any invalid alteration of (f1, f2, e1, e2)
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(f1, e1));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(f1, e2));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh1>(e1, f1));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh1>(e1, f2));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh1>(e1, e2));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(f2, e1));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh1>(f2, e2));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh1>(e2, f1));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh1>(e2, f2));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh1>(e2, e1));
    using bh2 =
        typed_beh<reacts_to<int>, reacts_to<int, int>, reacts_to<int, int, int>, reacts_to<int, int, int, int>,
                  reacts_to<int, int, int, int, int>, reacts_to<int, int, int, int, int, int>,
                  reacts_to<int, int, int, int, int, int, int>, reacts_to<int, int, int, int, int, int, int, int>,
    ...
    BOOST_CHECK_EQUAL(bi_pair(true, 10), tb_assign<bh2>(h0, h1, h2, h3, h4, h5, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 0), tb_assign<bh2>(e1, h1, h2, h3, h4, h5, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 1), tb_assign<bh2>(h0, e1, h2, h3, h4, h5, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 2), tb_assign<bh2>(h0, h1, e1, h3, h4, h5, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 3), tb_assign<bh2>(h0, h1, h2, e1, h4, h5, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 4), tb_assign<bh2>(h0, h1, h2, h3, e1, h5, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 5), tb_assign<bh2>(h0, h1, h2, h3, h4, e1, h6, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 6), tb_assign<bh2>(h0, h1, h2, h3, h4, h5, e1, h7, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 7), tb_assign<bh2>(h0, h1, h2, h3, h4, h5, h6, e1, h8, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 8), tb_assign<bh2>(h0, h1, h2, h3, h4, h5, h6, h7, e1, h9));
    BOOST_CHECK_EQUAL(bi_pair(false, 9), tb_assign<bh2>(h0, h1, h2, h3, h4, h5, h6, h7, h8, e1));
