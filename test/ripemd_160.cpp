...
#define BOOST_TEST_MODULE detail.ripemd_160

#include <nil/actor/detail/ripemd_160.hpp>
...
using nil::actor::detail::ripemd_160;
...
BOOST_AUTO_TEST_CASE(hash_results) {
    ...
    BOOST_CHECK_EQUAL("5d0689ef49d2fae572b881b123a85ffa21595f36", str_hash("message digest"));
    BOOST_CHECK_EQUAL("f71c27109c692c1b56bbdceb5b9d2865b3708dbc", str_hash("abcdefghijklmnopqrstuvwxyz"));
