...
BOOST_AUTO_TEST_CASE(ordering) {
    ...
    BOOST_CHECK_LESS(a0.wh, a1.wh);
    BOOST_CHECK_LESS(a0.wh, a1.dt);
    BOOST_CHECK_LESS(a0.wh, a1.st);
    BOOST_CHECK_LESS(a0.dt, a1.wh);
    BOOST_CHECK_LESS(a0.dt, a1.dt);
    BOOST_CHECK_LESS(a0.dt, a1.st);
    BOOST_CHECK_LESS(a0.st, a1.wh);
    BOOST_CHECK_LESS(a0.st, a1.dt);
    BOOST_CHECK_LESS(a0.st, a1.st);
    BOOST_CHECK_LESS(a0.wh, a2.wh);
    BOOST_CHECK_LESS(a0.wh, a2.dt);
    BOOST_CHECK_LESS(a0.wh, a2.st);
    BOOST_CHECK_LESS(a0.dt, a2.wh);
    BOOST_CHECK_LESS(a0.dt, a2.dt);
    BOOST_CHECK_LESS(a0.dt, a2.st);
    BOOST_CHECK_LESS(a0.st, a2.wh);
    BOOST_CHECK_LESS(a0.st, a2.dt);
    BOOST_CHECK_LESS(a0.st, a2.st);
    // all handles in a1 are less than handles in a2
    BOOST_CHECK_LESS(a1.wh, a2.wh);
    BOOST_CHECK_LESS(a1.wh, a2.dt);
    BOOST_CHECK_LESS(a1.wh, a2.st);
    BOOST_CHECK_LESS(a1.dt, a2.wh);
    BOOST_CHECK_LESS(a1.dt, a2.dt);
    BOOST_CHECK_LESS(a1.dt, a2.st);
    BOOST_CHECK_LESS(a1.st, a2.wh);
    BOOST_CHECK_LESS(a1.st, a2.dt);
    BOOST_CHECK_LESS(a1.st, a2.st);
